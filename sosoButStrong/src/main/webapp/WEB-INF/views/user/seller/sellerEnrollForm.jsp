...
<head>
	...
	<link rel="stylesheet" href="resources/css/user/seller/sellerEnrollForm.css">
</head>
<body>
		...
		<form id="enroll-form" action="sellerInsert.se" method="post" enctype="multipart/form-data">
		    <div class="bodyLR">
			    ...
			    <div class="right" style="position: relative;">
		   			<!-- header3 -->
			   		<div id="header3"><h5 id="title">사업장 정보</h5></div>
			   		<!-- wrapper -->
				    <div id="wrapper" >
					    <!-- content-->
					    <div id="content">
					        ...
					        <div>
					            ...
					            <span class="box">
					                ...
					                <button type="button" id="sellerName_btn" onclick= "BRNCheck()">조회</button>
					            </span>
					        </div>
