...
<head>
<meta charset="UTF-8">
<title>레시피 댓글 신고 상세</title>
<link rel="stylesheet" href="resources/css/admin/report/replyReportDetailView.css">
</head>
<body>
    <div class="wrap">
        <div id="menubar">
        ...
        <div class="content">
            <div class="content_1">
                ...
                <a class="btn btn-outline-secondary" href="replyReportList.re">목록가기</a>
            </div>
            <div class="content_3">
                ...
                <div class="content3_2">
                    ...
                    <table align="center">
                        <tr>
                            <td width="150px">${ reR.userId } 님</td>
                            <td width="300px">${ reR.replyContent}</td>
                            <td width="150px">${ reR.createDate}</td>
                            <td width="130px" class="btn_area">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="post" action="deleteReplyReport.re" id="postForm">
    ...
    <div class="modal delete-form fade" id="deleteForm2">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">취소</button>
                    <form method="post" action="rejectReplyReport.re" id="postForm">
                        <input type="hidden" name="reportUserNo" value="${ coA.reportUserNo }">
                    	<input type="hidden" name="reportCom" value="${ coA.comNo }">
