    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/wemasal/fileUpload.se'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/wemasal/fileUpload.co',	// 컨트롤러에서 요청할 URL
 	        sCallback : '/resources/smarteditor2/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
